...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'car_track_training = reinforcement_learning.car_track_training:main',
            'car_track_1_training = reinforcement_learning.car_track_1_training:main',
            'car_track_2_training = reinforcement_learning.car_track_2_training:main',
