...
class CarOvertakeEnvironment(F1tenthEnvironment):
        ...
        if self.is_multi_track:
            if self.IS_EVAL:
                ...
                self.CURR_TRACK = random.choice(
                    list(self.all_track_waypoints.keys())[: self.EVAL_TRACK_BEGIN_IDX]
                )
    ...
    def step(self, action):
        ...
        self.CENTRE_LINE_OFFSET = self.CURR_TRACK_MODEL.get_distance_to_spline_point(
            ...
            match modifier_type:
                ...
                case "turn":
                    ...
                    turning_penalty_factor = 1 - (
                        1 / (1 + np.exp(15 * (angular_vel_diff - 0.3)))
