...
class CarTrackEnvironment(F1tenthEnvironment):
    ...
    def __init__(self, 
        ...
        self.MAX_ACTIONS = np.asarray([config['track_actions']['max_speed'], config['track_actions']['max_turn']])
        self.MIN_ACTIONS = np.asarray([config['track_actions']['min_speed'], config['track_actions']['min_turn']])
