...
def get_all_goals_and_waypoints_in_multi_tracks(track_name):
    ...
    elif track_name == 'narrow_multi_bumpy_track':
        # Goal position - goals deprecated for narrow tracks
        all_car_goals = None
        
        # Waypoints - reordered with vary_track_width_new first, with larger spacing
        vary_track_width_new_wp = waypoints['vary_track_width_new']
        track_01_wp = [(x + 22, y, yaw, index) for x, y, yaw, index in waypoints['track_01_1m_bumpy']]
        track_02_wp = [(x + 31, y, yaw, index) for x, y, yaw, index in waypoints['track_02_1m_bumpy']]
        track_03_wp = [(x + 40, y, yaw, index) for x, y, yaw, index in waypoints['track_03_1m_bumpy']]
        track_04_wp = [(x + 49, y, yaw, index) for x, y, yaw, index in waypoints['track_04_1m_bumpy']]
        track_05_wp = [(x + 58, y, yaw, index) for x, y, yaw, index in waypoints['track_05_1m_bumpy']]
        track_06_wp = [(x + 67, y, yaw, index) for x, y, yaw, index in waypoints['track_06_1m_bumpy']]
