    ...
    if track_name == "multi_track_full":
        ...
        for width in WIDTHS:
            for track in TRACKS:
                ...
                global_wp = [
                    (x + i * 30, y, yaw, index)
                    for x, y, yaw, index in waypoints[track_name]
                ]
                all_car_waypoints.update({track_name: global_wp})
                i += 1
        ...
        track_01_2m_wp = [
            (x + 280, y, yaw, index) for x, y, yaw, index in waypoints["track_01_2m"]
        ]
        track_02_2m_wp = [
            (x + 296, y, yaw, index) for x, y, yaw, index in waypoints["track_02_2m"]
        ]
        track_03_2m_wp = [
            (x + 312, y, yaw, index) for x, y, yaw, index in waypoints["track_03_2m"]
        ]
        track_04_2m_wp = [
            (x + 328, y, yaw, index) for x, y, yaw, index in waypoints["track_04_2m"]
        ]
        track_05_2m_wp = [
            (x + 344, y, yaw, index) for x, y, yaw, index in waypoints["track_05_2m"]
        ]
        track_06_2m_wp = [
            (x + 360, y, yaw, index) for x, y, yaw, index in waypoints["track_06_2m"]
        ]
        all_car_waypoints = {
